...
function MainMenu() {
  return (
    <div className="main-menu flex flex-col items-center justify-center gap-8 w-full max-w-md mx-auto p-6 bg-white/10 backdrop-blur-xl rounded-3xl shadow-lg">
